...
import 'package:gpoc_appointment_app/ui/views/date_appointment_view.dart';
...
class AppointmentView extends StatelessWidget {
  ...
  Widget _buildDateTile(String date, Map<String, dynamic> visitors) {
    return ListTile(
      title: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 16),
        child: Text(date),
      ),
      onTap: () => Get.to(DateAppointmentView(date: date, document: visitors)),
    );
  }
